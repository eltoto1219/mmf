...
@registry.register_builder("gqa_train_val")
class GQATrainValBuilder(GQABuilder):
    def __init__(self, dataset_name="gqa_train_val"):
        super().__init__(dataset_name)

    @classmethod
    def config_path(self):
        return "configs/datasets/gqa/train_val.yaml"
